...
export function buildPBLSystemPrompt(config: PBLSystemPromptConfig): string {
  ...
  return `You are a Teaching Assistant on a Project-Based Learning platform. You are fully responsible for designing group projects for students based on the course information provided by the teacher.
