export const settingsZhCN = {
  settings: {
    ...
    dataManagement: '数据管理',
    exportSettings: '导出设置',
    exportSettingsDescription: '下载所有配置包括模型提供方、音频设置、用户资料等为 JSON 文件，用于备份或迁移。',
    export: '导出',
    exportSuccess: '设置导出成功',
    exportFailed: '设置导出失败',
    importSettings: '导入设置',
    importSettingsDescription: '从之前导出的 JSON 文件恢复设置。这将覆盖当前配置。',
    import: '导入',
    importDropzone: '拖放 JSON 文件到此处或点击浏览',
    importFileTypes: '支持：.json 文件',
    importValid: '有效的导入文件',
    importInvalid: '无效的导入文件',
    importExportedAt: '导出时间',
    importKeysCount: '要恢复的设置项',
